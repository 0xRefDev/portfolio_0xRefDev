...
export function ChangeLanguage() {
  ...
  return (
    <button
      ...
      className="flex items-center justify-center font-modak border-2 border-[#0F1A38]/60 rounded-full sm:text-2xl sm:px-2 px-1 py-1 cursor-pointer w-[4rem] sm:w-[6rem] h-fit text-md text-[#0F1A38]/90"
    >
      <LangIcon  />
      {language === "es" ? "ES" : "EN"}
    </button>
